...
// import { type UploadFileAction } from './uploadFileAction.js';
...
//   let commandHandler: UploadFileAction;
...
//     commandHandler = container.get<UploadFileAction>(symbols.uploadUserBookImageCommandHandler);
